...
// });
//
// d3.csv("dataForTowedCar.csv", function(error, data) {
//     console.log(data);
// });
...
d3.json("world.json", function(error, data) {
    d3.json("orange.json", function(error, orange) {
        ...
        //how can I import all of the coords and add label on it

        orange.features = orange.features.filter(function(d) {
           return d.geometry != null;
        });
        console.log("here");

        var points = svg.selectAll("circle")
            .data(orange.features);
